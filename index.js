...
const allowedOrigins = ['http://localhost', 'http://localhost:8080','http://127.0.0.1:5501','http://127.0.0.1','http://127.0.0.1:5500','http://127.0.0.1:5501/index.html','http://test.synagro.com.ar'];
app.use(cors({
